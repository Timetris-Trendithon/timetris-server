...
public enum ErrorStatus {
    ...
    PDS_NOT_FOUND_ERROR(HttpStatus.NOT_FOUND, "COMMON400", "해당 일자에 PDS가 작성되지 않았습니다."),

    SEE_ALREADY_EXISTS_ERROR(HttpStatus.BAD_REQUEST, "COMMON400", "해당 일자에 이미 see가 존재합니다."),
    TIME_CRASH_ERROR(HttpStatus.BAD_REQUEST, "COMMON400", "해당 시간에 이미 다른 일정이 존재합니다."),
